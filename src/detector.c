...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *train_images = option_find_str(options, "train", "E:/yolov2/darknet-master/build/darknet/x64/data/train.txt");
    char *backup_directory = option_find_str(options, "backup", "E:/yolov2/darknet-master/build/darknet/x64/backup/");
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh)
{
    list *options = read_data_cfg(datacfg);
    //char *name_list = option_find_str(options, "names", "data/names.list");
	char *name_list = option_find_str(options, "names", "E:/yolov2/darknet-master/data/coco.names");
   //char **names = get_labels(name_list);
	 char **names = get_labels("E:/yolov2/darknet-master/data/coco.names");
    ...
    if(0==strcmp(argv[2], "test")) test_detector(datacfg, cfg, weights, filename, thresh);
       ...
       /* char *name_list = option_find_str(options, "names", "data/names.list");
		...
		else
		{
			...
			char **names = get_labels("d:/yolov2/build/x64/data/coco.names");
			demo(cfg, weights, thresh, -1, filename, names, classes, frame_skip, prefix);
		}
